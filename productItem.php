<?php
include('opendb.php');
$sql_category = mysqli_query($conn, "SELECT * FROM loaisp");
$sql_product = mysqli_query($conn, "SELECT * FROM sanpham, loaisp WHERE sanpham.idLoaiSP = loaisp.idLoaiSP");
// $sql_product_cate = myqli_query($conn, "SELECT")
$row_product
?>
